...
- Growth empty state (1 month only): sample preview line chart (4 months, gold dots per point, dimmed at 50% opacity) with caption "Sample data — yours will appear here"; motivates recording next month
